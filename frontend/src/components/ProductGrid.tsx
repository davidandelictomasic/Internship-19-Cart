    ...
    <div className="px-4 mt-3">
      <div className="flex gap-3">
        <div className="flex-1 flex flex-col gap-3">
          ...
          >
            <div className="flex items-center justify-center pt-[28px] gap-[30px] bg-white">
              <img src={zutePatike} alt="Niske tenisice" className="object-contain max-h-[140px] px-2" />
            </div>
            <div className="px-3 py-2" style={{ backgroundColor: "rgba(192, 138, 91, 0.85)" }}>
          ...
          >
            <div className="flex-1 flex items-center justify-center pt-[28px] gap-[30px] bg-white">
              <img src={crnaKosulja} alt="Crna košulja" className="object-contain max-h-[200px] px-2" />
            </div>
            <div className="px-3 py-2" style={{ backgroundColor: "rgba(90, 62, 54, 0.85)" }}>
              <p className="text-white text-sm font-medium">Budite spremni za posebne prilike!</p>
          ...
          <div
            className="rounded-lg overflow-hidden flex flex-col cursor-pointer"
            style={{ border: "1px solid rgba(128, 128, 128, 1)", height: "409px" }}
            onClick={() => navigate('/search?category=Sport')}
          >
            <div className="flex-1 flex flex-col items-center justify-between pt-[28px] bg-white">
              <img src={plavePatike} alt="Plave patike" className="object-contain max-h-[140px] px-2" />
              <img src={sivaTuta} alt="Siva tuta" className="object-contain max-h-[140px] px-2" />
            </div>
            <div className="px-3 py-2" style={{ backgroundColor: "rgba(128, 128, 128, 0.85)" }}>
              <p className="text-white text-sm font-medium">Sportski trendovi</p>
              <div className="flex justify-end items-center">
                <span className="text-white text-xs">{">"}</span>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          >
            <div className="flex-1 flex flex-col items-center justify-between pt-[28px] bg-white">
              <img src={crniSweater} alt="Crni sweater" className="object-contain max-h-[140px] px-2" />
              <img src={sivaHoodica} alt="Siva hoodica" className="object-contain max-h-[140px] px-2" />
            </div>
            <div className="px-3 py-2" style={{ backgroundColor: "rgba(128, 128, 128, 0.85)" }}>
              <p className="text-white text-sm font-medium">Istraži našu casual kolekciju!</p>
              <div className="flex justify-end items-center">
                <span className="text-white text-xs">{">"}</span>
              </div>
            </div>
          ...
          >
            <div className="flex items-center justify-center pt-[28px] gap-[30px] bg-white">
              <img src={spidermanMajica} alt="Spiderman majica" className="object-contain max-h-[140px] px-2" />
            </div>
            <div className="px-3 py-2" style={{ backgroundColor: "rgba(192, 138, 91, 0.85)" }}>
